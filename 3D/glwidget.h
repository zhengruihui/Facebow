...
public:
    ...
    void cameraPerspectiveLookAtTop();
...
private:
    ...
    QByteArray vPointsSkull1;
    QByteArray tPointsSkull1;
    QByteArray nPointsSkull1;

    QByteArray vPointsSkull2;
    QByteArray tPointsSkull2;
    QByteArray nPointsSkull2;
