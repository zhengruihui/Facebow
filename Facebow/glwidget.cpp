...
{
    ui->setupUi(this);
    camera_pos = QVector3D(0.0f, 3.0f, 0.0f);
    light_pos = QVector3D(0.0f, 4.0f, 0.0f);
...
void GLWidget::computeNormalVectors(size_t num_vertices)
{
...
void GLWidget::paintGL()
{
    ...
    modelMat.rotate(30.0f, QVector3D(0.7f, 0.5f, 0.2f));
